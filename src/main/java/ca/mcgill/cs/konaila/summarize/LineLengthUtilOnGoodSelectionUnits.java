...
public class LineLengthUtilOnGoodSelectionUnits {
	...
	public static Map<Integer,String> getUidToFormattedCode(
		...
		Map<Integer,String> uidToCode = DatabasePredictions.selectSelectionUnitCode(
				c, cid, SummarizationMethod.ConfigurationBased);
