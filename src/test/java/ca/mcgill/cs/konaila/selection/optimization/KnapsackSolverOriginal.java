...
public class KnapsackSolverOriginal {
    ...
    public static void main(String[] args) {
        ...
        randomData(N, W, profit, weight);
        
        knapsack(N, W, profit, weight);
    } 

    public static void randomData(int N, int W, int[] profit, int[] weight) {
    ...
    public static boolean[] knapsack( int N, int W, int[] profit, int[] weight) {
